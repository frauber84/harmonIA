# coding=utf-8
# WordCloud.py modificado para harmonIA
...
class WordCloud(object):
    ...
    def __init__(self, font_path=None, width=400, height=200, margin=2,
                 ...
                 relative_scaling='auto', regexp=None, collocations=None,
                 colormap=None, normalize_plurals=False, contour_width=0,
                 contour_color='black', repeat=False,
                 include_numbers=True, min_word_length=1, collocation_threshold=30):
